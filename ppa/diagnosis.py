...
class Algorithm:
    ...
    def dx(self, n_tb=0, n_nontb=0):
        ...
        if self.Xpert is not None:
            ...
            if specimen is not self.Xpert.Specimen and self.Xpert.Specimen is not None:
                specimen = self.Xpert.Specimen
...
if __name__ == '__main__':
    ...
    for alg in [alg1, alg2, alg3, alg4]:
        print(' ')
        print(alg.Key)
        alg.dx(1000, 1000).print(True)
        print(' ')
        alg.dx_sto(1000, 1000).print(True)

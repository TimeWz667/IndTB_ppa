...
for (cnr_year in 2019:2021) {
  ...
  save(pars_shifting, file = here::here("out", folder, "pars_shifting.rdata"))  
}



# ## Check results
# pdi <- sim_shifting$India$Sim$p_diag
# shift <- sim_shifting$India$Sim$tr_mat[, 1:3] + sim_shifting$India$Sim$tr_mat[, 4:6]
# 
# 
